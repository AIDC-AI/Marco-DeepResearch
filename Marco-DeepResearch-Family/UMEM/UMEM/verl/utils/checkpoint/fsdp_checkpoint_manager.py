            ...
            if self.rank == 0:
                ...
                if save_model.can_generate():
                    if generation_config is not None:
                        ...
                        logger.warning("%s.save_checkpoint: generation config file not found; using a config created from the model config when saving hf_model.", self.__class__.__name__)
