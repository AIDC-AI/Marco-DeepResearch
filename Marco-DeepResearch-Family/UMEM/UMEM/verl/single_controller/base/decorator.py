...
def _concat_data_proto_or_future(output: List):
    ...
    for item in output:
        assert type(item) is type(output[0])
...
def _unsupported_model_parallel(*args, **kwargs):
    raise NotImplementedError("Model-parallel dispatch is not supported by this UMEM training path.")
...
DISPATCH_MODE_FN_REGISTRY = {
    ...
    Dispatch.MEGATRON_COMPUTE: {"dispatch_fn": _unsupported_model_parallel, "collect_fn": _unsupported_model_parallel},
    Dispatch.MEGATRON_PP_AS_DP: {"dispatch_fn": _unsupported_model_parallel, "collect_fn": _unsupported_model_parallel},
    Dispatch.MEGATRON_PP_ONLY: {"dispatch_fn": _unsupported_model_parallel, "collect_fn": _unsupported_model_parallel},
    Dispatch.MEGATRON_COMPUTE_PROTO: {"dispatch_fn": _unsupported_model_parallel, "collect_fn": _unsupported_model_parallel},
    Dispatch.MEGATRON_PP_AS_DP_PROTO: {"dispatch_fn": _unsupported_model_parallel, "collect_fn": _unsupported_model_parallel},
